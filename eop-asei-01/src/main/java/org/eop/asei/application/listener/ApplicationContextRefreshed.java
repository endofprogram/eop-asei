package org.eop.asei.application.listener;

import org.eop.common.redis.serializer.JdkAndStringValueRedisSerializer;
...
public class ApplicationContextRefreshed implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		//重新设置key/value的序列化器
		if (event.getApplicationContext().containsBean("redisTemplate")) {
